  ...
  <>
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          <img
            src="https://blindlingdev.github.io/pseudorator/krivka.png"
            alt="Density plot"
            width="600"
            height="400"
          />
    ...
    <p>
      The tool was developed as part of an ongoing research project on phonotactic probability
      in pseudoword processing.
    </p>
    <p>
      If you use this tool in your research or for other purposes, please cite
      the following references (to be completed after the review process):
    </p>
    <ul>
      <li>
